...
access = "0YrFK6xANhxUiumEBiDYvH9HQGn656TwHxhPEzcX"
secret = "LdXCkXLgFLJx200NrfWbxrhriiwJfqHh9KmTmCDa"
...
predict_price("KRW-AXS")
schedule.every().hour.do(lambda: predict_price("KRW-AXS"))
